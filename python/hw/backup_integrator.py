...
class Integrator(IntegratorHwIf):
    ...
    def __init__(self, mode, num_samples, num_periods, window, integrator_type, debug=False):
        ...
        if self.debug:
            print(f'Integrator settings : mode={mode}, type={integrator_type} num_samples={num_samples}, num_periods={num_periods} window={window}')
